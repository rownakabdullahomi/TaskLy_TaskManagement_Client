    ...
    <div className="px-4 lg:px-6">
      <div className="navbar justify-between py-2">
        ...
        <div className="flex items-center">
          ...
          >
            <span className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-purple-600 blur-lg opacity-30 group-hover:opacity-70 transition-opacity duration-300"></span>
            <div className="relative text-gray-700 group-hover:text-white transition-colors duration-300">
            <span className="text-blue-500">Task</span>ly
            </div>
          </Link>
            ...
            {dropdownOpen && (
              <ul className="menu dropdown-content bg-base-100 rounded-box mt-3 w-52 p-2 shadow z-10">
                <li className="font-bold italic text-xl my-2 mx-auto tracking-tight relative group">
                  <span className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-purple-600 blur-lg opacity-30 group-hover:opacity-70 transition-opacity duration-300 mb-5"></span>
                  <Link
                    to={"/"}
